...
export const LEVELS: LevelConfig[] = [
    ...
    { id: 'w1-1', worldId: 1, targetWord: 'CAT', foils: ['DOG', 'FISH', 'BIRD'] },
    { id: 'w1-2', worldId: 1, targetWord: 'DOG', foils: ['CAT', 'PIG', 'COW'] },
    { id: 'w1-3', worldId: 1, targetWord: 'PIG', foils: ['DOG', 'FOX', 'BEAR'] },
