      ...
      `} />
          ...
          `]}
                >
                    ...
                    {partsRemaining >= 4 && (
                        <>
                            <div css={css`position: absolute; top: 22px; left: 18px; width: 8px; height: 8px; background: #374151; border-radius: 50%;`} />
                            <div css={css`position: absolute; top: 22px; right: 18px; width: 8px; height: 8px; background: #374151; border-radius: 50%;`} />
                        </>
                    )}
                    {/* Nose */}
                    {partsRemaining >= 5 && (
          ...
          `}
                >
                    <div css={css`width: 40px; height: 35px; background: #374151; border-radius: 4px 4px 0 0;`} />
                    <div css={css`width: 60px; height: 8px; background: #374151; border-radius: 4px;`} />
                </motion.div>
            )}
        </div>
    );
